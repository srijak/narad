...
#import "SRICredentialsManager.h"
#import <Security/Security.h>

@implementation SRICredentialsManager





static NSString *SRICredentialsManagerErrorDomain = @"SRICredentialsManagerErrorDomain";
...
+(NSString *) getPasswordForUsername: (NSString *) username andServiceName: (NSString *) serviceName error: (NSError **) error {
  if (!username || !serviceName) {
    *error = [NSError errorWithDomain: SRICredentialsManagerErrorDomain code: -2000 userInfo: nil];
    return nil;
  }
  ...
  if (status != noErr) {
    *error = [NSError errorWithDomain: SRICredentialsManagerErrorDomain code: status userInfo: nil];
    return nil;
  }
...
+ (NSString *) getPasswordForUsername: (NSString *) username andServiceName: (NSString *) serviceName error: (NSError **) error {
  ...
  if (status != noErr) {
    if (status == errSecItemNotFound) {
      ...
      if (error != nil) {
        *error = [NSError errorWithDomain: SRICredentialsManagerErrorDomain code: -1999 userInfo: nil];
      }
    }
    else {
...

{
  ...
  NSString *existingPassword = [SRICredentialsManager getPasswordForUsername: username andServiceName: serviceName error:&getError];
