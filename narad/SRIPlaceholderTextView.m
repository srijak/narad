...
@interface SRIPlaceholderTextView ()
...
@implementation SRIPlaceholderTextView
...
- (void) setPlaceholder:(NSString *)aPlaceholder {
  if ([self.realText isEqualToString:self.placeholder] && ![self isFirstResponder]) {
    self.text = aPlaceholder;
  }
  if (aPlaceholder != self.placeholder) {
